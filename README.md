...
:warning: si vous utiliser un proxy référer vous à la partie [Configuration du proxy dans la section Configuration en tant qu'Administrateur](#configuration-en-tant-quadministrateur)
...
](https://github.com/Eliott133/dockerisation-application-gestion-de-rame/blob/master/my-train-auto-history/api/Dockerfile). Il est également nécessaire de configurer le proxy directement sur docker desktop. [Comment configurer le proxy sur Docker Desktop](https://linuxhint.com/configure-docker-for-use-with-proxy/).
